...
namespace Libplanet.Tests.Crypto
{
    public class PrivateKeyTest
    {
        ...
        {
            var key = new PrivateKey(ByteUtils.ParseHex(
        ...
        {
            var pk = new PrivateKey(ByteUtils.ParseHex(
                "520938fae079789561268c2933f636d8b5a0011ea04112dbababf295e5ddef88"));
            var payload = ByteUtils.ParseHex(
        ...
        {
            var prvKey = new PrivateKey(ByteUtils.ParseHex(
                "82fc9947e878fc7ed01c6c310688603f0a41c8e8704e5b990e8388343b0fd465"));
            byte[] pubkeyBytes = ByteUtils.ParseHex(
        ...
        {
            var key1 = new PrivateKey(ByteUtils.ParseHex(
                "fbc20042b3a707a7d5a1fa577171f49cd3a9e67ab9295757c714e3f2f8c2d573"));
            var key2 = new PrivateKey(ByteUtils.ParseHex(
                "fbc20042b3a707a7d5a1fa577171f49cd3a9e67ab9295757c714e3f2f8c2d573"));
            var key3 = new PrivateKey(ByteUtils.ParseHex(
