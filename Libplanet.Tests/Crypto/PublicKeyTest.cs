...
namespace Libplanet.Tests.Crypto
{
    public class PublicKeyTest
    {
        ...
        {
            var pubKey = new PublicKey(ByteUtils.ParseHex(
            ...
            var signature = ByteUtils.ParseHex(
        ...
        {
            var key1 = new PublicKey(ByteUtils.ParseHex(
